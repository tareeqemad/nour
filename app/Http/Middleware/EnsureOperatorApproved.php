...
class EnsureOperatorApproved
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        // المستخدمون غير المرتبطين بأي مشغّل (مثل أصحاب الأدوار العامة) لا يخضعون لقيد اعتماد المشغّل
        // وصولهم للصفحات تحكمه صلاحياتهم وسياسات كل صفحة
        if (! $user->isCompanyOwner() && ! $user->getAffiliatedOperator()) {
            return $next($request);
        }
