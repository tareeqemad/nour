...
- يتم تشفيره باستخدام `Hash::make()` قبل الحفظ في قاعدة البيانات
- يتم استخدام كلمة المرور النصية (مؤقتاً) فقط لإرسالها عبر SMS، ولا يتم حفظها في قاعدة البيانات
...
- يتم حفظ كلمة المرور مشفرة فقط باستخدام `Hash::make()`
- يتم استخدام كلمة المرور النصية (مؤقتاً) فقط لإرسالها عبر SMS، ولا يتم حفظها في قاعدة البيانات
