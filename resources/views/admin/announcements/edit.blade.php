...
@php
    $breadcrumbTitle = 'تعديل الإعلان';
    $breadcrumbParent = 'الإعلانات';
    $breadcrumbParentUrl = route('admin.announcements.index');
@endphp

@section('content')
    <div class="general-page" id="announcementsEditPage">
        <div class="row g-3">
            <div class="col-12">
                <x-admin.card>
                    <x-admin.card-header-form title="تعديل الإعلان" icon="bi-megaphone" :backRoute="route('admin.announcements.index')" />
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                          rows="5" required>{{ old('description', $announcement->description) }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch d-flex align-items-center gap-2 p-3 border rounded" style="background:#FAFCFF;">
                                    <input class="form-check-input" type="checkbox" name="is_featured" id="is_featured"
                                           value="1" {{ old('is_featured', $announcement->is_featured) ? 'checked' : '' }} style="width:2.5em;height:1.3em;">
                            ...
                            <div class="col-md-6">
                                <div class="form-check form-switch d-flex align-items-center gap-2 p-3 border rounded" style="background:#FAFCFF;">
                                    <input class="form-check-input" type="checkbox" name="is_visible" id="is_visible"
                                           value="1" {{ old('is_visible', $announcement->is_visible) ? 'checked' : '' }} style="width:2.5em;height:1.3em;">
