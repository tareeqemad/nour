            ...
            <div class="col-12">
                <div class="general-card">
                        ...
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 mb-0">
                            <div>
                                <div class="general-title">
                                    ...
                                    تعديل نسبة خصم الموظفين
                                </div>
                                <div class="general-subtitle">
                                    قم بتعديل بيانات نسبة خصم موظفي الشركة
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('admin.employee-discount-rates.update', $discountRate) }}" method="POST" id="discountRateForm">
                            @csrf
                            @method('PUT')
