                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.subscribers.store') }}" method="POST" id="subscriberForm">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold">رقم الاشتراك <span class="text-danger">*</span></label>
                                    <input type="text" name="subscription_number" class="form-control @error('subscription_number') is-invalid @enderror" 
                                           value="{{ old('subscription_number') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="subscription_date" class="form-control @error('subscription_date') is-invalid @enderror" 
                                           value="{{ old('subscription_date') }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="subscription_category" class="form-select @error('subscription_category') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ old('subscription_category') == '1' ? 'selected' : '' }}>منزلي</option>
                                        <option value="2" {{ old('subscription_category') == '2' ? 'selected' : '' }}>تجاري</option>
                                        <option value="3" {{ old('subscription_category') == '3' ? 'selected' : '' }}>خدماتي</option>
                                        <option value="4" {{ old('subscription_category') == '4' ? 'selected' : '' }}>صناعي</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="phase_type" class="form-select @error('phase_type') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ old('phase_type') == '1' ? 'selected' : '' }}>1 فاز</option>
                                        <option value="2" {{ old('phase_type') == '2' ? 'selected' : '' }}>3 فاز</option>
                                    </select>
                                    @error('phase_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="subscription_status" class="form-select @error('subscription_status') is-invalid @enderror" required>
                                        ...
                                        <option value="1" {{ old('subscription_status') == '1' ? 'selected' : '' }}>نشط</option>
                                        <option value="2" {{ old('subscription_status') == '2' ? 'selected' : '' }}>موقوف</option>
                                        <option value="3" {{ old('subscription_status') == '3' ? 'selected' : '' }}>مغلق</option>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="service_type" class="form-select @error('service_type') is-invalid @enderror" required>
                                        <option value="">اختر النوع</option>
                                        <option value="1" {{ old('service_type') == '1' ? 'selected' : '' }}>مولد</option>
                                        <option value="2" {{ old('service_type') == '2' ? 'selected' : '' }}>شمسي</option>
                                        <option value="3" {{ old('service_type') == '3' ? 'selected' : '' }}>هجين</option>
                                    </select>
                                    @error('service_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="generation_unit_ids[]" class="form-select @error('generation_unit_ids') is-invalid @enderror" multiple size="5" required>
                                        @foreach($generationUnits as $unit)
                                            <option value="{{ $unit->id }}" {{ in_array($unit->id, old('generation_unit_ids', [])) ? 'selected' : '' }}>
