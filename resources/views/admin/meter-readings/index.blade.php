...
(function() {
    ...
    $('#bulkApproveFilterBtn').on('click', function() {
        ...
        Swal.fire({
            ...
            html: 'سيتم اعتماد القراءات غير المعتمدة المطابقة للفلاتر (الطبيعية + غير الطبيعية باستهلاك صفري).<br>القراءات غير الطبيعية الأخرى (سالب أو متجاوزة للحد) تحتاج تعديلاً قبل الاعتماد.',
            icon: 'question',
            showCancelButton: true,
            confirmButtonColor: '#198754',
            cancelButtonColor: '#6c757d',
