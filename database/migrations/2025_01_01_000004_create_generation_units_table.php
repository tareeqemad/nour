...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('generation_units', function (Blueprint $table) {
            ...
            $table->string('operator_name')->nullable()->comment('اسم المشغل (يستخدم في حالة "طرف آخر")');
            ...
            // QR Code
            $table->timestamp('qr_code_generated_at')->nullable()->comment('تاريخ توليد QR Code');
